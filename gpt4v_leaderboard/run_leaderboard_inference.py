"""
Make GPT4+V API calls to get a set of leaderboard predictions
...
def main():
    ...
    for instance in tqdm.tqdm(instances):
        if instance["instance_id"] in id2resp:
            continue
...
E: {E}""".format(
        ...
        cache.write(
            json.dumps({"instance_id": instance["instance_id"], "response": result})
            + "\n"
        )
